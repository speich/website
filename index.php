...
<figure><a href="<?php echo $url; ?>" title="zufällig gewähltes Foto aus der Bildatenbank"><img class="imgFrame" src="<?php echo $src; ?>"
                alt="Foto: <?php echo $photo->ImgTitle ?>" width="100%" height="100%"></a>
