...
<link href="../library/dojo/1.17.3/dijit/themes/soria/soria.css" rel="stylesheet" type="text/css">
<style type="text/css">
#log {
	padding: 8px;
...
<script src="../library/dojo/1.17.3/dojo/dojo.js" dojo-data-config="async: true, locale: '<?php echo $locale = $language->get(); ?>'"></script>
