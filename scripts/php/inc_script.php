...
if ($lang->get() === 'de') {
	...
	$htmlFooterLeft['de'] = '<p>© 2003-2019 speich.net, Konzept und Programmierung Simon Speich</p>';
	$htmlFooterRight['de'] = 'letzte Aktualisierung '.$web->lastUpdate;
    if (strpos($_SERVER['REQUEST_URI'], '/photo') !== false) {
        $htmlFooterLeft['de'] .= '<p><a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/3.0/deed.de"><img alt="Creative Commons Lizenzvertrag" src="https://i.creativecommons.org/l/by-nc-sa/3.0/80x15.png"></a>
    ...
    $htmlFooterLeft['en'] = '<p>© 2003-2019 speich.net, concept und programming Simon Speich</p>';
    $htmlFooterRight['en'] = 'last update '.$web->lastUpdate;
    if (strpos($_SERVER['REQUEST_URI'], '/photo') !== false) {
        $htmlFooterLeft['en'] .= '<p><a rel="license" href="https://creativecommons.org/licenses/by-nc/3.0/"><img alt="Creative Commons licence" src="https://i.creativecommons.org/l/by-nc-sa/3.0/80x15.png"></a>
