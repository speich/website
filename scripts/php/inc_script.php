...
if ($web->page === 'remoteFileExplorer.php') {
    ...
    $cspHeader->set('script-src', "'self' 'unsafe-inline' 'unsafe-eval' https://*.googleapis.com https://*.gstatic.com *.google.com https://*.ggpht.com *.googleusercontent.com blob:");
    $cspHeader->set('img-src', "'self' https://*.googleapis.com https://*.gstatic.com *.google.com  *.googleusercontent.com data:");
