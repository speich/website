...
class SearchQuery
{
     ...
     * The number of characters a string has to contain to be counted as a word can be set with the parameter $minWordLength.
     * @param string $text
     * @param int $maxWords
     * @param int $minWordLength
     * @return array
     */
    public static function extractWords(string $text, int $maxWords = 6, int $minWordLength = 3): array
    {
     ...
     * @return string
     */
    public static function createQuery(array $words, string $lang): string
    {
        $search = '';
        $len = count($words);
