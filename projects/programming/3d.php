...
<p>Mozilla testcase can be found <a href="3d.htm" onclick="return openWin('3d.htm', 'www.speich.net - Mozilla Testcase for Bug 229391', 330, 560)">here</a> (opens in new window).</p>
<div id="viewAreaCont">
<div id="viewArea" onClick="Play ? Play = false: Play = true; return false;" style="top: 0px; left: 0px; width: 300px; height: 300px; /* has to be set inline */">
