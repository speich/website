...
<head>
    ...
    <meta name="keywords"
            content="Simon Speich, nature photography, photo, photography, web programming, photo archive, JavaScript, PHP, nature, animals, birds, wildlife">
...
<p>Do you enjoy looking at beautiful, high-resolution photos of wildlife and nature, especially of <a href="photo/photodb/photo-en.php?theme=1">birds</a> and of
    ...
    from time to time.</p>
<p>If you are interested more in web programming (<a href="articles/en/category/php/">PHP</a>, <a href="articles/en/category/javascript/">JavaScript</a>,
    <a href="articles/en/category/sql/">SQL</a> or <a href="articles/en/category/cascading-style-sheets-css/">CSS</a>) as well as other IT topics (<a
            href="articles/en/tag/linux/">Linux</a>, <a href="articles/en/tag/virtualbox/">VirtualBox</a>), then read one of the articles,
