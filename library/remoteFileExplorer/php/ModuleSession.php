...
class ModuleSession extends FileExplorer {
	...
	public function __construct($rootDir) {
		...
		if (!isset($_SESSION['rfe'])) {
			$_SESSION['rfe'] = array(
				$rootDir => serialize($this->fsDefault),
				'lastUsedItemId' => count($this->fsDefault)	// this is a very simple way which is not very robust // TODO: better way to create an id
			);
		}
	}
