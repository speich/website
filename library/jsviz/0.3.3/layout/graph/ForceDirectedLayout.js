...
ForceDirectedLayout.prototype.setSize = function() {
	...
	// correction for NAFIDAS layout
	//this.containerLeft = this.containerLeft + 195;	// offset div main
	//this.containerTop = this.containerTop + 150;		// offset div main
	
	this.view.setSize(this.containerLeft, this.containerTop,	this.containerWidth, this.containerHeight);
