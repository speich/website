...
add_action('wp_enqueue_scripts', static function() {
    ...
    wp_enqueue_style('prismjs', '/../library/prismjs/1.24.1/themes/prism.min.css');
    wp_enqueue_script('prismjs', '/../library/prismjs/1.24.1/components/prism-core.min.js');
    wp_enqueue_script('prism-autoloader', '/../library/prismjs/1.24.1/plugins/autoloader/prism-autoloader.min.js');
});
